...
public class TestJdbcPersistentController_2 extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testQueueName() {
        Assert.assertEquals("JDBCQueuePersistenceController." +
                        "ru.kwanza.jeda.persistentqueue.jdbc.queue.NamedEventQueue:queueName=queue1",
                controller1.getQueueName());
        Assert.assertEquals("JDBCQueuePersistenceController" +
                        ".ru.kwanza.jeda.persistentqueue.jdbc.queue.NamedEventQueue:queueName=queue2",
