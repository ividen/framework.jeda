...
public class TestJdbcPersistentController_3 extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testQueueName() {
        Assert.assertEquals("JDBCQueuePersistenceController.ru.kwanza.jeda.persistentqueue.jdbc.queue.PriorityEventQueue",
