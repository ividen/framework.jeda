...
public class TestDBPersistentController_4 extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testQueueName() {
        Assert.assertEquals("DBQueuePersistenceController." +
                        "ru.kwanza.jeda.persistentqueue.db.queue.NamedPriorityEventQueue:queueName=queue1",
                controller1.getQueueName());
        Assert.assertEquals("DBQueuePersistenceController" +
                        ".ru.kwanza.jeda.persistentqueue.db.queue.NamedPriorityEventQueue:queueName=queue2",
