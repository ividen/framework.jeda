...
public class TestJdbcPersistentController_1 extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testQueueName() {
        Assert.assertEquals("JDBCQueuePersistenceController.ru.kwanza.jeda.persistentqueue.jdbc.queue.EventQueue",
    ...
    public void testPersist() throws Exception {
        ...
        Assertion.assertEqualsIgnoreCols(getResourceSet("dataset_1.xml"),
    ...
    public void testDelete() throws Exception {
        ...
        Assertion.assertEqualsIgnoreCols(getResourceSet("dataset_2.xml"),
                getActualDataSet("jeda_jdbc_event_queue"), "jeda_jdbc_event_queue", new String[]{"data"});
    }
