 ...
 */
public class TestTransactionalMemoryQueueWithArjuna extends TestTransactionalMemoryQueueWithStubTrx {
    private JBossTransactionManager arjuna;
    ...
    public static TestSuite suite() {
        return new TestSuite(TestTransactionalMemoryQueueWithArjuna.class);
    }
