 ...
 */
public class TestTransactionalMemoryQueueWithAtamikos extends TestTransactionalMemoryQueueWithStubTrx {
    ...
    public static TestSuite suite() {
        return new TestSuite(TestTransactionalMemoryQueueWithAtamikos.class);
    }
